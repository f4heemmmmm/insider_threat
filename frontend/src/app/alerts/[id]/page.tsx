...
/**
 * AlertDetailPage for comprehensive security alert analysis and management.
 * 
 * Provides detailed alert investigation capabilities including:
 * - Alert header with severity classification and incident status tracking
 * - MITRE ATT&CK framework mapping for threat categorization
 * - Evidence analysis with expandable sections for detailed investigation
 * - Raw event data display for forensic analysis and threat hunting
 * - Alert logs timeline for activity tracking and audit trails
 * - Responsive design with loading states and comprehensive error handling
 */
