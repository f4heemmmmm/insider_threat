    ...
    return (
        <div className = "p-8">
            <div className = "flex justify-between items-start">
                ...
                <div className = {`flex items-start ${severityColor}`}>
                    <div>
                        <span className = "font-light text-2xl">{alert.score}</span>
                            ...
                            <div className = "flex flex-col gap-4">
                                {alert.MITRE_tactic && (
                                    <div className = "flex items-center text-sm">
                                        ...
                                        <span className = "text-gray-700 font-light bg-gray-200 px-3 py-1 rounded-md inline-block"> {alert.MITRE_tactic} </span>
                                    </div>
                                )}
                                {alert.MITRE_technique && (
                                    <div className = "flex items-center text-sm">
                                        <span className = "font-medium text-black mr-1 w-32"> MITRE Technique: </span>
                                        <span className = "text-gray-700 font-light bg-gray-200 px-3 py-1 rounded-md inline-block"> {alert.MITRE_technique} </span>
                                    </div>
                                )}
                                {alert.Detection_model && (
                                    <div className = "flex items-center text-sm">
                                        <span className = "font-medium text-black mr-1 w-32"> Detection Model: </span>
                                        <span className = "text-gray-700 font-light bg-gray-200 px-3 py-1 rounded-md inline-block"> {alert.Detection_model} </span>
                                    </div>
                                )}
                                {alert.Description && (
                                    <div>
